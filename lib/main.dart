...
import 'package:login_form_flutter/onboarding_screens.dart';
...
class _LoginForm extends State<FormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:
            AppBar(title: Text('Login Form'), backgroundColor: Colors.blueGrey),
